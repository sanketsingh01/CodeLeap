...
import codePagePreview from "@/assets/CodePage.webp";
...
function SetupVisual() {
    return (
        <>
            <div
                className="group/timer relative mx-auto flex size-32 items-center justify-center rounded-full border-4 border-dashed bg-background shadow-xs outline outline-border outline-offset-4 transition-colors duration-300 ease-in-out hover:border-[#f0e105] hover:outline-[#f0e105]">
                <div
                    className="absolute inset-0 z-10 scale-120 bg-radial from-foreground/20 via-foreground/5 to-transparent blur-xl" />
                <CustomTimerIcon className="size-14 transition-colors duration-300 ease-in-out group-hover/timer:fill-[#f0e105]" />
            </div>
            <div className="relative mt-8 space-y-1.5 text-center">
                <FeatureTitle>Track Speed</FeatureTitle>
                <FeatureDescription>
                    Monitor the spped of your problem solving process.
                </FeatureDescription>
            </div>
        </>
    );
    ...
    return (
        <div className="grid h-full sm:grid-cols-2">
            <div className="relative z-10 space-y-6 py-8 ps-8 pe-2">
                <div
                    className="flex size-12 items-center justify-center rounded-full border bg-card shadow-xs outline outline-border/80 outline-offset-2">
        ...
        <svg
            ...
            <defs>
                <clipPath id="clip0_0_1">
                    <rect fill="currentColor" height="72" transform="translate(41)" width="129" />
                </clipPath>
            </defs>
        </svg>
    );
...
function CustomTimerIcon(props) {
    return (
...
function ReportsChartsSvg(props) {
    return (
        <svg
            fill="none"
            viewBox="0 0 300 128"
            ...
            <defs>
                <linearGradient
                    ...
                    y1="60"
                    y2="123">
                    <stop className="text-[#25C526]" stopColor="currentColor" />
                    <stop
                ...
                <clipPath id="clip0_0_106">
                    <rect fill="white" height="30" transform="translate(14 14)" width="358" />
                </clipPath>
            </defs>
        </svg>
    );
