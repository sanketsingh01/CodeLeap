...
const Comunitysection = () => {
  ...
  return (
    <div className="relative w-full px-36 py-12 mt-8" ref={ref}>
      {/* Background Image with pop-out animation */}
      <motion.img
        src={Comunitybg}
        alt="Join community bg"
        className="w-full object-cover h-[700px] rounded-4xl"
      ...
      >
        <div>
          <span className="parkinsans-font text-white text-8xl font-bold">
            Join Our{" "}
          </span>
          <span className="parkinsans-font text-[#F4FF54] text-8xl font-bold">
            Community
          </span>
        </div>
        ...
        {/* Social Icons */}
        <motion.div
          className="mt-8 flex justify-center gap-8 text-white text-5xl"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
