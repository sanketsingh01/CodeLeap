...
const problemSchema = z.object({
  ...
  refrenceSolution: z.object({
    JAVASCRIPT: z.string().min(1, "Javascript refrence solution is required"),
    PYTHON: z.string().min(1, "Python refrence solution is required"),
    JAVA: z.string().min(1, "Java refrence solution is required"),
  }),
});
...
const CreateProblemForm = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl mt-18">
